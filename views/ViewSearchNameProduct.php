...
<div class="box-all-product">
  ...
  <div class="product-hot go">
    <div class="title-hot" id="hotcl">
      <h5 class="show-and-hide">Tìm kiếm - Từ khóa: <?php echo $key ?></h5>
    </div>
  ...
  <div style="margin-left: 5%;">
    <ul class="pagination">
      ...
      <?php for ($i = 1; $i <= $numPage; $i++) : ?>
        <li class="page-item " style="padding-left: 10px;"><a class="page-link" href="tim-kiem/key-<?php echo $key ?>/trang-<?php echo $i; ?>.html"><?php echo $i; ?></a></li>
      <?php endfor; ?>
    </ul>
  </div>
  <!-- end paging -->
