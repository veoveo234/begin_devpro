...
<div class="box-all-product">
    ...
    <div class="product-hot go">
        <div class="title-hot" id="hotcl">
            <h5 class="show-and-hide"><?php echo $nameCategory->name ?></h5>
            <div class="choose-select">
                <select name="" id="" onchange="location.href = 'danh-muc-con/sap-xep/<?php echo $category_id; ?>/<?php echo $this->removeUnicode($nameCategory->name) ?>/'+this.value+'.html';">
    ...
    <div style="margin-left: 5%;">
        <ul class="pagination">
            ...
            <?php for ($i = 1; $i <= $numPage; $i++) : ?>
                <li class="page-item " style="padding-left: 10px;"><a class="page-link" href="danh-muc-con/<?php echo $nameCategory->id ?>/<?php echo $this->removeUnicode($nameCategory->name) ?>/trang-<?php echo $i; ?>.html"><?php echo $i; ?></a></li>
            <?php endfor; ?>
        </ul>
    </div>
    <!-- end paging -->
